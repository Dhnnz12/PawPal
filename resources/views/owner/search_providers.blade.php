...
@section('dashboard_content')
    <div class="py-2">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
            <div>
                <h1 class="h3 mb-1" style="font-family: 'Fraunces', serif; font-weight: 700; color: var(--ink);">Cari Penyedia Layanan 🐾</h1>
                <div class="small text-muted" style="font-family: 'Outfit', sans-serif;">Pilih tipe penyedia layanan terbaik untuk kebutuhan hewan peliharaan Anda.</div>
            </div>
        ...
        <div class="row g-4">
            <div class="col-12 col-md-4">
                <div class="pet-card p-4">
                    ...
                    <form method="GET" action="{{ route('booking.search') }}">
                        <div class="mb-4">
                            <label class="form-label fw-semibold small text-muted">Kategori Provider</label>
                            <select class="form-select pet-input w-100" name="type" style="height: 50px;">
                                ...
                                <option value="pet_sitter" {{ $type==='pet_sitter'?'selected':'' }}>Pet Sitter (Penitipan)</option>
                            </select>
                        </div>
            ...
            <div class="col-12 col-md-8">
                <div class="pet-card p-4">
                    <h2 class="h5 mb-3" style="font-family: 'Fraunces', serif; font-weight: 700;">Rekomendasi Provider Terdekat 🧡</h2>
